...
public class ConfigSettings {
    ...
    public static void createConfig(UnicacityAddon unicacityAddon, List<SettingsElement> list) {
        ...
        list.add(new HeaderElement(
                Message.getBuilder().of("U").color(ColorCode.RED).bold().advance().of("nica").color(ColorCode.BLUE).bold().advance().of("C").color(ColorCode.RED).bold()
                        .advance().of("ity").color(ColorCode.BLUE).bold().advance().of("A").color(ColorCode.RED).bold().advance().of("ddon").color(ColorCode.BLUE).bold()
                        .advance().space().of("v" + UnicacityAddon.VERSION).color(ColorCode.BLUE).bold().advance().space().of("-").color(ColorCode.GRAY).bold().advance().space()
                        .of("by RettichLP").color(ColorCode.GOLD).advance().create()));
        ...
        BooleanElement nameTagAlliance = new BooleanElement("Bündnismarkierung", unicacityAddon, new ControlElement.IconData(Material.PINK_DYE), "NAMETAG_ALLIANCE",
                ConfigElements.getNametagAlliance());
        nameTagAlliance.setSubSettings(nameTagAllianceSettings());
        list.add(nameTagAlliance);

        BooleanElement nameTagStreetwar = new BooleanElement("Streetwarmarkierung", unicacityAddon, new ControlElement.IconData(Material.IRON_SWORD), "NAMETAG_STREETWAR",
